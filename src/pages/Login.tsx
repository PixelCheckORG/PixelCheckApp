                ...
                <div className="h-full flex items-center justify-center p-12">
                    <div className="max-w-lg text-white">
                        <h3 className="text-4xl font-bold mb-6">
                            Detecta imágenes generadas por IA con precisión
                        </h3>
                        <p className="text-xl text-blue-100 mb-8">
                            Nuestra tecnología avanzada analiza cada píxel para identificar si una imagen es real, generada por IA o diseño gráfico.
                        </p>
                        <ul className="space-y-4">
                            <li className="flex items-start">
                                ...
                                <span className="text-blue-100">Análisis detallado de múltiples características</span>
                            </li>
                            <li className="flex items-start">
                                <svg className="w-6 h-6 text-blue-200 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                </svg>
                                <span className="text-blue-100">Historial de análisis guardado</span>
                            </li>
                            <li className="flex items-start">
                                <svg className="w-6 h-6 text-blue-200 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                </svg>
                                <span className="text-blue-100">Exportación de resultados (Premium)</span>
                            </li>
                        </ul>
                    </div>
                </div>
