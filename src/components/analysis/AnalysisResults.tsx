                ...
                {isPremium && results.reportId && (
                    <div className="mt-4 pt-3 border-t border-gray-100 dark:border-gray-700">
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-medium rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {isDownloading ? (
                                <>
